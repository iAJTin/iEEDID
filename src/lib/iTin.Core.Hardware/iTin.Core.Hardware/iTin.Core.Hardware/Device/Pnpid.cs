...
{ 
    ...
    /// <summary>
    /// Static class that allows the name of a manufacturer to be obtained from its <c>Pnp</c> identification code.
    /// For more information, please see http://www.uefi.org/pnp_id_list.
    /// </summary> 
    public static class PnpId
    {
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static readonly Dictionary<string, string> PnpNamesTable = new Dictionary<string, string>
        {
            {"AAA", "Avolites Ltd"},
            ...
            {"ABV", "Tecnología de Investigación Avanzada"},
            ...
            {"ACK", "Acksys"},
            {"ACL", "Ordenadores del albaricoque"},
            {"ACM", "Acroloop Motion Control Systems Inc"},
            {"ACO", "Allion Computer Inc."},
            {"ACP", "Aspen Tech Inc"},
            {"ACR", "Tecnologías Acer"},
            {"ACS", "Altos Computer Systems"},
            {"ATA", "Tecnología Creativa Aplicada"},
            {"CUA", "Acculogic"},
            {"CVA", "ActivCard SA"},
            {"DAA", "Addi-Data GmbH"},
            {"DBA", "Aldebbaron"},
            {"DCA", "Acnhor Datacomm"},
            {"DDA", "Advanced Peripheral Devices Inc"},
            {"DEA", "Arithmos, Inc."},
            {"DHA", "Aerodata Holdings Ltd"},
            {"DIA", "ADI Systems Inc"},
            {"DKA", "Adtek System Science Company Ltd"},
            {"DLA", "ASTRA Security Products Ltd"},
            {"DMA", "Ad Lib MultiMedia Inc"},
            {"DNA", "Analog & Digital Devices Tel. Inc"},
            {"DPA", "Adaptec Inc"},
            {"DRA", "Centro de Investigación Nasa Ames"},
            {"DSA", "Analog Devices Inc"},
            {"DTA", "Adtek"},
            {"DVA", "Advanced Micro Devices Inc"},
            {"DXA", "Adax Inc"},
            {"DZA", "ADDER TECHNOLOGY LTD"},
            {"ECA", "Antex Electronics Corporation"},
            {"EDA", "Advanced Electronic Designs, Inc."},
            {"EIA", "Actiontec Electric Inc"},
            {"EJA", "Alpha Electronics Company"},
            {"EMA", "ASEM SpA"},
            {"ENA", "Avencall"},
            {"EPA", "Aetas Periféricos Internacionales"},
            {"ETA", "Aethra Telecomunicazioni Srl"},
            {"FAA", "Alfa Inc"},
            {"GCA", "Beijing Aerospace Golden Card Electronic Engineering Co., Ltd."},
            {"GIA", "Artish Graphics Inc"},
            {"GLA", "Argólida"},
            {"GMA", "Advan Int'l Corporation"},
            {"GOA", "AlgolTek, Inc."},
            {"GTA", "Agilent Technologies"},
            {"HCA", "Advantech Co., Ltd."},
            {"HQA", "Astro HQ LLC"},
            {"HSA", "Beijing AnHeng SecoTech Information Technology Co., Ltd."},
            {"ICA", "Arnos Insturments & Computer Systems"},
            {"IEA", "Altmann Industrieelektronik"},
            {"IIA", "Amptron International Inc."},
            {"IKA", "Dongguan Alllike Electronics Co., Ltd."},
            {"ILA", "Altos India Ltd"},
            {"IMA", "AIMS Lab Inc"},
            {"IRA", "Integral Avanzado. Investigación Inc"},
            {"ISA", "Servicios de Internet para extranjeros"},
            {"IWA", "Aiwa Company Ltd"},
            {"IXA", "ALTINEX, INC."},
            {"JAA", "AJA Video Systems, Inc."},
            {"KBA", "Akebia Ltd"},
            {"KEA", "AKAMI Electric Co., Ltd"},
            {"KIA", "AKIA Corporation"},
            {"KLA", "AMiT Ltd"},
            {"KMA", "Asahi Kasei Microsystems Company Ltd"},
            {"KPA", "Atom Komplex Prylad"},
            {"KYA", "Askey Computer Corporation"},
            {"LAA", "Alacron Inc"},
            {"LCA", "Altec Corporation"},
            {"LDA", "In4S Inc"},
            {"LEA", "Alenco BV"},
            {"LGA", "Realtek Semiconductor Corp."},
            {"LHA", "Sistemas AL"},
            {"LIA", "Acer Labs"},
            {"LJA", "Altec Lansing"},
            {"LKA", "Acrolink Inc"},
            {"LLA", "Alliance Semiconductor Corporation"},
            {"LMA", "Acutec Ltd."},
            {"LNA", "Alana Technologies"},
            {"LOA", "Algolith Inc."},
            {"LPA", "Alps Electric Company Ltd"},
            {"LRA", "Lógica Avanzada"},
            {"LSA", "Avance Logic Inc"},
            {"LTA", "Altra"},
            {"LVA", "AlphaView LCD"},
            {"LXA", "ALEXON Co., Ltd."},
            {"MAA", "Asia Microelectronic Development Inc"},
            {"MBA", "Ambient Technologies, Inc."},
            {"MCA", "Attachmate Corporation"},
            {"MDA", "Amdek Corporation"},
            {"MIA", "American Megatrends Inc"},
            {"MLA", "Anderson Multimedia Communications (HK) Limited"},
            {"MNA", "Amimon LTD."},
            {"MOA", "Amino Technologies PLC y Amino Communications Limited"},
            {"MPA", "AMP Inc"},
            {"MRA", "AmTRAN Technology Co., Ltd."},
            {"MSA", "ARMSTEL, Inc."},
            {"MTA", "Industria Internacional AMT"},
            {"MXA", "AMX LLC"},
            {"NAA", "Anakron"},
            {"NCA", "Ancot"},
            {"NDA", "Adtran Inc"},
            {"NIA", "Anigma Inc"},
            {"NKA", "Anko Electronic Company Ltd"},
            {"NLA", "Analogix Semiconductor, Inc"},
            {"NOA", "Corporación Anorad"},
            {"NPA", "Andrew Network Production"},
            {"NRA", "ANR Ltd"},
            {"NSA", "Ansel Communication Company"},
            {"NTA", "Ace CAD Enterprise Company Ltd"},
            {"NVA", "Beijing ANTVR Technology Co., Ltd."},
            {"NWA", "Analog Way SAS"},
            {"NXA", "Acer Netxus Inc"},
            {"OAA", "AOpen Inc."},
            {"OEA", "Advanced Optics Electronics, Inc."},
            {"OLA", "America OnLine"},
            {"OTA", "Alcatel"},
            {"PCA", "American Power Conversion"},
            {"PDA", "AppliAdata"},
            {"PEA", "Alpine Electronics, Inc."},
            {"PGA", "Horner Electric Inc"},
            {"PIA", "A Plus Info Corporation"},
            {"AAA", "Avolites Ltd"},
            {"AAE", "Anatek Electronics Inc."},
            {"AAM", "Aava Mobile Oy"},
            {"AAN", "AAEON Technology Inc."},
        ...
        /// <summary>
        /// Returns the name associated with the specified <c>Pnp</c>.
        /// </summary>
        /// <param name="key">key of three charaters</param>
        /// <returns>
        /// Returns a <see cref="T:ystem.String"/> that contains the name associated with the specified <c>Pnp</c>.
        /// </returns>
        public static string PnpName(string key)
        {
            ...
            var existKey = PnpNamesTable.ContainsKey(key);
            return 
                existKey 
                    ? PnpNamesTable[key] 
                    : string.Empty;
