...
namespace iTin.Hardware.Specification.Eedid.Blocks.DisplayId.Sections.DataBlocks
{
    ...
    internal sealed class DetailedTimingTypeIDataBlock : BaseDataSection
    {
        ...
        #region [public] DetailedTimingTypeIDataBlock(ReadOnlyCollection<byte>, int? = null): Initialize a new instance of the class with the data of this block untreated with version block
        /// <summary>
        ...
        public DetailedTimingTypeIDataBlock(ReadOnlyCollection<byte> dataBlock, int? version = null) : base(dataBlock, version)
        {
        }
        #endregion
