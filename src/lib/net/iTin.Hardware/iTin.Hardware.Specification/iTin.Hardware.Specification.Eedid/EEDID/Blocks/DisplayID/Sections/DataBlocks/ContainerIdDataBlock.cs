...
namespace iTin.Hardware.Specification.Eedid.Blocks.DisplayId.Sections.DataBlocks
{
    ...
    internal sealed class ContainerIdDataBlock : BaseDataSection
    {
        ...
        #region [public] ContainerIdDataBlock(ReadOnlyCollection<byte>, int? = null): Initialize a new instance of the class with the data of this block untreated with version block
        /// <summary>
        ...
        public ContainerIdDataBlock(ReadOnlyCollection<byte> dataBlock, int? version = null) : base(dataBlock, version)
        {
        }
        #endregion
        ...
        #region [private] (string) UUID: Gets a value representing the 'UUID' field
        /// <summary>
