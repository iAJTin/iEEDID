...
namespace iTin.Hardware.Specification.Eedid.Blocks.EDID.Sections
{
    ...
    /// Represents the <see cref="EdidSection.BasicDisplay"/> section of this block <see cref="KnownDataBlock.EDID"/>.
    /// </summary> 
    internal sealed class BasicDisplaySection : BaseDataSection
    {
        #region constructor/s

        #region [public] BasicDisplaySection(ReadOnlyCollection<byte>): Initialize a new instance of the class with the data in this section untreated
        /// <summary>
        /// Initialize a new instance of the <see cref="BasicDisplaySection"/> class with the data in this section untreated.
        /// </summary>
        /// <param name="sectionData">Unprocessed data in this section</param>
        public BasicDisplaySection(ReadOnlyCollection<byte> sectionData) : base(sectionData)
        {
        }
        #endregion
