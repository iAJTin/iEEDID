...
namespace iTin.Core.Hardware.Specification.Eedid
{
    ...
    /// </summary> 
    sealed class BasicDisplayEdidSection : BaseDataSection
    {
        ...
        {
            object value = null;
            var propertyId = (KnownEdidBasicDisplayProperty)propertyKey.PropertyId;

            switch (propertyId)
            {
                #region [0x00] - [Basic Parameters]

                #region [0x00] - [Basic Parameters -> Video Input Definition] - [String]
                case KnownEdidBasicDisplayProperty.VideoInputDefinition:
                        value = DigitalVideoInputDefinitionValue;
                        break;
                    #endregion

                #region [0x00] - [Basic Parameters -> Video Input Definition - > Analog]

                #region [0x00] - [Basic Parameters -> Video Input Definition - > Analog -> Signal Level Standard] - [String]
                case KnownEdidBasicDisplayProperty.AnalogSignalLevelStandard:
                    value = GetSignalLevelStandard(SignalLevelStandard);
                    break;
                #endregion

                #region [0x00] - [Basic Parameters -> Video Input Definition - > Analog -> Video Setup] - [String]
                case KnownEdidBasicDisplayProperty.AnalogVideoSetup:
                    value = VideoSetup;
                    break;
                #endregion

                #region [0x00] - [Basic Parameters -> Synchronizacion Types]

                #region [0x00] - [Basic Parameters -> Synchronizacion Types -> Separate Sync H & V Signals Supported] - [Boolean]
                case KnownEdidBasicDisplayProperty.AnalogSeparateSyncSupported:
                    value = SeparateSyncSupported;
                    break;
                #endregion

                #region [0x00] - [Basic Parameters -> Synchronizacion Types -> Composite Sync Signal on Horizontal Supported] - [Boolean]
                case KnownEdidBasicDisplayProperty.AnalogCompositeSyncSignalHorizontalSupported:
                    value = CompositeSyncSignalHorizontalSupported;
                    break;
                #endregion

                #region [0x00] - [Basic Parameters -> Synchronizacion Types -> Composite Sync Signal on Green Video Supported] - [Boolean]
                case KnownEdidBasicDisplayProperty.AnalogCompositeSyncSignalGreenVideoSupported:
                    value = CompositeSyncSignalGreenVideoSupported;
                    break;
                #endregion

                #endregion

                #region [0x00] - [Basic Parameters -> Video Input Definition - > Analog -> Vertical Sync Supported] - [Boolean]
                case KnownEdidBasicDisplayProperty.AnalogVerticalSyncSupported:
                    value = VerticalSyncSupported;
                    break;
                #endregion

                #endregion

                #region [0x00] - [Basic Parameters -> Video Input Definition - > Digital]

                #region [0x00] - [Basic Parameters -> Video Input Definition - > Digital -> Color Bit Depth] - [String]
                case KnownEdidBasicDisplayProperty.DigitalColorBitDepth:
                    value = GetColorBitDepth(ColorBitDepth);
                    break;
                #endregion

                #region [0x00] - [Basic Parameters -> Video Input Definition - > Digital -> Digital Video Interface] - [String]
                case KnownEdidBasicDisplayProperty.DigitalVideoInterface:
                    value = GetDigitalVideoInterface(DigitalVideoInterface);
                    break;
                #endregion
                ...
                #region [0x01] - [Horizontal Screen Size or Aspect Ratio] - [Byte] - [cm]
                case KnownEdidBasicDisplayProperty.HorizontalScreenSize:
                    value = HorizontalScreenSize;
                    break;
                #endregion

                #region [0x02] - [Vertical Screen Size or Aspect Ratio] - [Byte] - [cm]
                case KnownEdidBasicDisplayProperty.VerticalScreenSize:
                    value = VerticalScreenSize;
                    break;
                #endregion

                #region [0x03] - [Display Transfer Characteristic (Gamma)] - [Double?]
                case KnownEdidBasicDisplayProperty.Gamma:
                    double gamma = Gamma;
                ...
                #region [0x04] - [Features]

                #region [0x04] - [Features -> Display Power Management]

                #region [0x04] - [Features -> Display Power Management -> Standby Mode Supported] - [Boolean]
                case KnownEdidBasicDisplayProperty.StandbyModeSupported:
                    value = StandbyModeSupported;
                    break;
                #endregion

                #region [0x04] - [Features -> Display Power Management -> Suspend Mode Supported] - [Boolean]
                case KnownEdidBasicDisplayProperty.SuspendModeSupported:
                    value = SuspendModeSupported;
                    break;
                #endregion

                #region [0x04] - [Features -> Display Power Management -> Active Off Supported] - [Boolean]
                case KnownEdidBasicDisplayProperty.ActiveOffSupported:
                    value = ActiveOffSupported;
                    break;
                #endregion

                #endregion

                #region [0x04] - [Features -> Analog -> Display Color Type] - [String]
                case KnownEdidBasicDisplayProperty.AnalogDisplayColorType:
                    bool digital0 = DigitalVideoInputDefinitionFlag;
                    if (!digital0)
                        value = GetDisplayColorType(DisplayColorType);
                    break;
                #endregion

                #region [0x04] - [Features -> Digital -> Supported Color Encoding Format(s)] - [String]
                case KnownEdidBasicDisplayProperty.DigitalColorEncodingFormat:
                    bool digital1 = DigitalVideoInputDefinitionFlag;
                    if (digital1)
                        value = GetSupportedColorEncodingFormat(ColorEncodingFormat);
                    break;
                #endregion

                #region [0x04] - [Features -> Other Features]

                #region [0x04] - [Features -> Other Features -> sRGB Standard] - [Boolean]
                case KnownEdidBasicDisplayProperty.SrgbDefaultColorSpace:
                    value = IssRgbDefaultColorSpace;
                    break;
                #endregion

                #region [0x04] - [Features -> Other Features -> Include Preferred Timming Mode] - [Boolean]
                case KnownEdidBasicDisplayProperty.PreferredTimingMode:
                    value = IncludePreferredTimingMode;
                    break;
                #endregion

                #region [0x04] - [Features -> Other Features -> Continuous Frequency] - [Boolean]
                case KnownEdidBasicDisplayProperty.ContinuousFrequency:
                    value = IsContinuousFrequency;
                    break;
                #endregion
        ...
        protected override void Parse(Hashtable items)
        {
            ...
            var digitalVideoInputDefinitionFlag = DigitalVideoInputDefinitionFlag;
                items.Add(KnownEedidPropertiesDefinition.Edid.BasicDisplay.VideoInputDefinition, DigitalVideoInputDefinitionValue);
                switch (digitalVideoInputDefinitionFlag)
                {
                    ...
                    case false:
                        ...
                        items.Add(KnownEedidPropertiesDefinition.Edid.BasicDisplay.Analog.SignalLevelStandard, GetSignalLevelStandard(SignalLevelStandard));
                        #endregion

                        #region Video Setup
                        items.Add(KnownEedidPropertiesDefinition.Edid.BasicDisplay.Analog.VideoSetup, VideoSetup);
                        #endregion

                        #region Synchronization Types
                        items.Add(KnownEedidPropertiesDefinition.Edid.BasicDisplay.Analog.Syncrhonization.SeparateSyncSupported, SeparateSyncSupported);
                        items.Add(KnownEedidPropertiesDefinition.Edid.BasicDisplay.Analog.Syncrhonization.CompositeSyncSignalHorizontalSupported, CompositeSyncSignalHorizontalSupported);
                        items.Add(KnownEedidPropertiesDefinition.Edid.BasicDisplay.Analog.Syncrhonization.CompositeSyncSignalGreenVideoSupported, CompositeSyncSignalGreenVideoSupported);
                        #endregion

                        #region Vertical Sync Supported
                        items.Add(KnownEedidPropertiesDefinition.Edid.BasicDisplay.Analog.VerticalSyncSupported, VerticalSyncSupported);
                        break;
                        #endregion
                    ...
                    case true:
                        ...
                        items.Add(KnownEedidPropertiesDefinition.Edid.BasicDisplay.Digital.ColorBitDepth, GetColorBitDepth(ColorBitDepth));
                        #endregion

                        #region Digital Video Interface Standard Supported
                        items.Add(KnownEedidPropertiesDefinition.Edid.BasicDisplay.Digital.VideoInterface, GetDigitalVideoInterface(DigitalVideoInterface));
                        break;
                        #endregion
            ...
            items.Add(KnownEedidPropertiesDefinition.Edid.BasicDisplay.HorizontalScreenSize, HorizontalScreenSize);
            #endregion

            #region Vertical Screen Size or Aspect Ratio
            items.Add(KnownEedidPropertiesDefinition.Edid.BasicDisplay.VerticalScreenSize, VerticalScreenSize);
            #endregion
            ...
            if (!gamma.Equals(0xff))
            {
                items.Add(KnownEedidPropertiesDefinition.Edid.BasicDisplay.Gamma, (double?)gamma);
            }
            #endregion
            ...
            items.Add(KnownEedidPropertiesDefinition.Edid.BasicDisplay.Features.DisplayPowerManagement.StandbyModeSupported, StandbyModeSupported);
            items.Add(KnownEedidPropertiesDefinition.Edid.BasicDisplay.Features.DisplayPowerManagement.SuspendModeSupported, SuspendModeSupported);
            items.Add(KnownEedidPropertiesDefinition.Edid.BasicDisplay.Features.DisplayPowerManagement.ActiveOffSupported, ActiveOffSupported);
            #endregion
            ...
            switch (digitalVideoInputDefinitionFlag)
            {
                #region Display Color Type
                case false:
                    items.Add(KnownEedidPropertiesDefinition.Edid.BasicDisplay.Analog.DisplayColorType, GetDisplayColorType(DisplayColorType));
                    break;
                #endregion

                #region Supported Color Encoding Format
                case true:
                    items.Add(KnownEedidPropertiesDefinition.Edid.BasicDisplay.Digital.ColorEncodingFormat, GetSupportedColorEncodingFormat(ColorEncodingFormat));
                    break;
                #endregion
            }
            #endregion
            ...
            items.Add(KnownEedidPropertiesDefinition.Edid.BasicDisplay.Features.Other.IsSrgbDefaultColorSpace, IssRgbDefaultColorSpace);
            items.Add(KnownEedidPropertiesDefinition.Edid.BasicDisplay.Features.Other.IncludePreferredTimingMode, IncludePreferredTimingMode);
            items.Add(KnownEedidPropertiesDefinition.Edid.BasicDisplay.Features.Other.IsContinuousFrequency, IsContinuousFrequency);
            #endregion
