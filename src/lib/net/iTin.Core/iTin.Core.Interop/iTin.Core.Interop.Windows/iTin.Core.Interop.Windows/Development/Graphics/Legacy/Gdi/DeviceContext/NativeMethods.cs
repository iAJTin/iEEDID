...
namespace iTin.Core.Interop.Shared.Windows.Development.Graphics.Legacy.Gdi.DeviceContext
{
    ...
    public static class NativeMethods
    {
        ...
        public enum ChangeDisplaySettingsFlags
        {
            ...
            /// <summary>
            /// When set, the <b> lParam </b> parameter is a pointer to a VIDEOPARAMETERS structure.
            /// </summary>
        ...
        /// </summary>
        /// <param name="lpDevice">Pointer to the device name. If it is <b>null</b>, it returns the information of all the video adapters on the device. To obtain the information of each adapter we must increase the value of the <c>iDevNum</c> parameter.</param>
