...
namespace iTin.Hardware.Specification.Eedid
{
    ...
    /// <inheritdoc />
    /// <summary>
    /// Especialización de la clase <see cref="T:iTin.Hardware.Specification.Eedid.BaseDataBlock" /> que representa al bloque <see cref="F:iTin.Hardware.Specification.Eedid.KnownDataBlock.LS" /> de la especificación <see cref="T:iTin.Hardware.Specification.EEDID" />.
    /// </summary> 
    internal class LsBlock : BaseDataBlock
    {
        ...
        /// <inheritdoc />
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="T:iTin.Hardware.Specification.Eedid.LsBlock" /> con los datos de este bloque sin tratar.
        /// </summary>
        /// <param name="dataBlock">Datos de este bloque sin tratar.</param>
        /// <remarks>
        /// Crear bloque <see cref="F:iTin.Hardware.Specification.Eedid.KnownDataBlock.LS" /> que pertenece a la especificación <see cref="T:iTin.Hardware.Specification.EEDID" />.
        /// </remarks>
