...
namespace iTin.Core.Hardware.Specification.Eedid
{
    ...
    public sealed class EdidProperties
    {
        ...
        public sealed class HeaderProperties
        {
            ...
            /// 	<para>Key: <see cref="EedidProperty.Edid.Header.Signature"/></para>
            ...
            /// </value>
            public DeviceProperty<ReadOnlyCollection<byte>> Value => _dataSection.GetProperty(EedidProperty.Edid.Header.Signature) as DeviceProperty<ReadOnlyCollection<byte>>;
            #endregion
            ...
            /// 	<para>Key: <see cref="EedidProperty.Edid.Header.IsValid"/></para>
            /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
            ...
            /// Objeto fuertemente tipado que representa el valor de la propiedad.
            /// </value>
            public DeviceProperty<bool> IsValid => _dataSection.GetProperty(EedidProperty.Edid.Header.IsValid) as DeviceProperty<bool>;
            #endregion
        ...
        public sealed class VendorProperties
        {
            ...
            #region Propiedades
                ...
                /// 	<para>Key: <see cref="EedidProperty.Edid.Vendor.IdManufacturerName"/></para>
                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.Vendor.IdManufacturerName) as DeviceProperty<String>; }
                }
                #endregion
                ...
                /// 	<para>Key: <see cref="EedidProperty.Edid.Vendor.IdProductCode"/></para>
                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                /// 	<para>Value: <see cref="T:System.String"/></para>
                /// </summary>
                /// <value>
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.Vendor.IdProductCode) as DeviceProperty<String>; }
                }
                #endregion
                ...
                /// 	<para>Key: <see cref="EedidProperty.Edid.Vendor.IdSerialNumber"/></para>
                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.Vendor.IdSerialNumber) as DeviceProperty<UInt32?>; }
                }
                #endregion
                ...
                /// 		</item>
                /// 	</list>
                /// 	<para>Key: <see cref="EedidProperty.Edid.Vendor.ManufactureDate"/></para>
                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                /// 	<para>Value: <see cref="T:System.String"/></para>
                /// </summary>
                /// <value>
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.Vendor.ManufactureDate) as DeviceProperty<Int32>; }
                }
                #endregion
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.Vendor.WeekOfManufacture) as DeviceProperty<Int32?>; }
                }
                #endregion
        ...
        public sealed class VersionProperties
        {
            ...
            #region Propiedades
                ...
                /// 	<para>— Información de la propiedad</para>
                /// 	<para>Description: Número de versión de la especificación implementada en este monitor.</para>
                /// 	<para>Key: <see cref="EedidProperty.Edid.Version.Number"/></para>
                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.Version.Number) as DeviceProperty<Byte>; }
                }
                #endregion
                ...
                /// 	<para>— Información de la propiedad</para>
                /// 	<para>Description: Número de revisión de la especificación implementada en este monitor.</para>
                /// 	<para>Key: <see cref="EedidProperty.Edid.Version.Revision"/></para>
                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                /// 	<para>Value: <see cref="T:System.Byte"/></para>
                /// 	<para>Si está característica no se encuentra disponible se devuelve <b>null</b></para>
                /// </summary>
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.Version.Revision) as DeviceProperty<Byte>; }
                }
                #endregion
        ...
        public sealed class BasicDisplayProperties
        {
            #region Clases anidadas
                ...
                public sealed class AnalogProperties
                {
                    #region Clases anidadas
                        ...
                        public sealed class SyncrhonizationProperties
                        {
                            ...
                            #region Propiedades
                                ...
                                /// 	<para>Key: <see cref="EedidProperty.Edid.BasicDisplay.Analog.Syncrhonization.SeparateSyncSupported"/></para>
                                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                                /// 	<para>Value: <see cref="T:System.Boolean"/></para>
                                /// </summary>
                                /// <value>
                                ...
                                {
                                    get { return _dataSection.GetProperty(EedidProperty.Edid.BasicDisplay.Analog.Syncrhonization.SeparateSyncSupported) as DeviceProperty<Boolean>; }
                                }
                                #endregion
                                ...
                                /// 	<para>— Información de la propiedad</para>
                                /// 	<para>Description: Profundidad de color de este escritorio.</para>
                                /// 	<para>Key: <see cref="EedidProperty.Edid.BasicDisplay.Analog.Syncrhonization.CompositeSyncSignalHorizontalSupported"/></para>
                                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                                /// 	<para>Value: <see cref="T:System.Boolean"/></para>
                                /// </summary>
                                /// <value>
                                ...
                                {
                                    get { return _dataSection.GetProperty(EedidProperty.Edid.BasicDisplay.Analog.Syncrhonization.CompositeSyncSignalHorizontalSupported) as DeviceProperty<Boolean>; }
                                }
                                #endregion
                                ...
                                /// 	<para>— Información de la propiedad</para>
                                /// 	<para>Description: Profundidad de color de este escritorio.</para>
                                /// 	<para>Key: <see cref="EedidProperty.Edid.BasicDisplay.Analog.Syncrhonization.CompositeSyncSignalGreenVideoSupported"/></para>
                                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                                /// 	<para>Value: <see cref="T:System.Boolean"/></para>
                                /// </summary>
                                /// <value>
                                ...
                                {
                                    get { return _dataSection.GetProperty(EedidProperty.Edid.BasicDisplay.Analog.Syncrhonization.CompositeSyncSignalGreenVideoSupported) as DeviceProperty<Boolean>; }
                                }
                                #endregion
                    ...
                    #region Propiedades
                        ...
                        /// 	<para>— Información de la propiedad</para>
                        /// 	<para>Description: Profundidad de color de este escritorio.</para>
                        /// 	<para>Key: <see cref="EedidProperty.Edid.BasicDisplay.Analog.SignalLevelStandard"/></para>
                        /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                        /// 	<para>Value: <see cref="T:System.String"/></para>
                        /// </summary>
                        /// <value>
                        ...
                        {
                            get { return _dataSection.GetProperty(EedidProperty.Edid.BasicDisplay.Analog.SignalLevelStandard) as DeviceProperty<String>; }
                        }
                        #endregion
                        ...
                        /// 	<para>— Información de la propiedad</para>
                        /// 	<para>Description: Profundidad de color de este escritorio.</para>
                        /// 	<para>Key: <see cref="EedidProperty.Edid.BasicDisplay.Analog.VideoSetup"/></para>
                        /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                        /// 	<para>Value: <see cref="T:System.String"/></para>
                        /// </summary>
                        /// <value>
                        ...
                        {
                            get { return _dataSection.GetProperty(EedidProperty.Edid.BasicDisplay.Analog.VideoSetup) as DeviceProperty<String>; }
                        }
                        #endregion
                        ...
                        /// 	<para>— Información de la propiedad</para>
                        /// 	<para>Description: Profundidad de color de este escritorio.</para>
                        /// 	<para>Key: <see cref="EedidProperty.Edid.BasicDisplay.Analog.VerticalSyncSupported"/></para>
                        /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                        /// 	<para>Value: <see cref="T:System.Boolean"/></para>
                        /// </summary>
                        /// <value>
                        ...
                        {
                            get { return _dataSection.GetProperty(EedidProperty.Edid.BasicDisplay.Analog.VerticalSyncSupported) as DeviceProperty<Boolean>; }
                        }
                        #endregion
                        ...
                        /// 	<para>— Información de la propiedad</para>
                        /// 	<para>Description: Profundidad de color de este escritorio.</para>
                        /// 	<para>Key: <see cref="EedidProperty.Edid.BasicDisplay.Analog.DisplayColorType"/></para>
                        /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                        /// 	<para>Value: <see cref="T:System.Boolean"/></para>
                        /// </summary>
                        /// <value>
                        ...
                        {
                            get { return _dataSection.GetProperty(EedidProperty.Edid.BasicDisplay.Analog.DisplayColorType) as DeviceProperty<String>; }
                        }
                        #endregion
                ...
                public sealed class DigitalProperties
                {
                    ...
                    #region Propiedades.
                        ...
                        /// 	<para>— Información de la propiedad</para>
                        /// 	<para>Description: Profundidad de color de este escritorio.</para>
                        /// 	<para>Key: <see cref="EedidProperty.Edid.BasicDisplay.Digital.ColorBitDepth"/></para>
                        /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                        /// 	<para>Value: <see cref="T:System.String"/></para>
                        /// 	<para>Si está característica no se encuentra disponible se devuelve <b>null</b></para>
                        /// </summary>
                        ...
                        {
                            get { return _dataSection.GetProperty(EedidProperty.Edid.BasicDisplay.Digital.ColorBitDepth) as DeviceProperty<String>; }
                        }
                        #endregion
                        ...
                        /// 	<para>— Información de la propiedad</para>
                        /// 	<para>Description: Profundidad de color de este escritorio.</para>
                        /// 	<para>Key: <see cref="EedidProperty.Edid.BasicDisplay.Digital.VideoInterface"/></para>
                        /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                        /// 	<para>Value: <see cref="T:System.String"/></para>
                        /// 	<para>Si está característica no se encuentra disponible se devuelve <b>null</b></para>
                        /// </summary>
                        ...
                        {
                            get { return _dataSection.GetProperty(EedidProperty.Edid.BasicDisplay.Digital.VideoInterface) as DeviceProperty<String>; }
                        }
                        #endregion
                        ...
                        /// 	<para>— Información de la propiedad</para>
                        /// 	<para>Description: Profundidad de color de este escritorio.</para>
                        /// 	<para>Key: <see cref="EedidProperty.Edid.BasicDisplay.Digital.ColorEncodingFormat"/></para>
                        /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                        /// 	<para>Value: <see cref="T:System.String"/></para>
                        /// 	<para>Si está característica no se encuentra disponible se devuelve <b>null</b></para>
                        /// </summary>
                        ...
                        {
                            get { return _dataSection.GetProperty(EedidProperty.Edid.BasicDisplay.Digital.ColorEncodingFormat) as DeviceProperty<String>; }
                        }
                        #endregion
                    ...
                    #region Clases anidadas.
                        ...
                        public sealed class OtherFeaturesProperties
                        {
                            ...
                            #region Propiedades.
                                ...
                                /// 	<para>— Información de la propiedad</para>
                                /// 	<para>Description: Profundidad de color de este escritorio.</para>
                                /// 	<para>Key: <see cref="EedidProperty.Edid.BasicDisplay.Features.Other.IsSrgbDefaultColorSpace"/></para>
                                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                                /// 	<para>Value: <see cref="T:System.Boolean"/></para>
                                /// 	<para>Si está característica no se encuentra disponible se devuelve <b>null</b></para>
                                /// </summary>
                                ...
                                {
                                    get { return _dataSection.GetProperty(EedidProperty.Edid.BasicDisplay.Features.Other.IsSrgbDefaultColorSpace) as DeviceProperty<Boolean>; }
                                }
                                #endregion
                                ...
                                /// 	<para>— Información de la propiedad</para>
                                /// 	<para>Description: Profundidad de color de este escritorio.</para>
                                /// 	<para>Key: <see cref="EedidProperty.Edid.BasicDisplay.Features.Other.IncludePreferredTimingMode"/></para>
                                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                                /// 	<para>Value: <see cref="T:System.Boolean"/></para>
                                /// 	<para>Si está característica no se encuentra disponible se devuelve <b>null</b></para>
                                /// </summary>
                                ...
                                {
                                    get { return _dataSection.GetProperty(EedidProperty.Edid.BasicDisplay.Features.Other.IncludePreferredTimingMode) as DeviceProperty<Boolean>; }
                                }
                                #endregion
                                ...
                                /// 	<para>— Información de la propiedad</para>
                                /// 	<para>Description: Profundidad de color de este escritorio.</para>
                                /// 	<para>Key: <see cref="EedidProperty.Edid.BasicDisplay.Features.Other.IsContinuousFrequency"/></para>
                                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                                /// 	<para>Value: <see cref="T:System.Boolean"/></para>
                                /// 	<para>Si está característica no se encuentra disponible se devuelve <b>null</b></para>
                                /// </summary>
                                ...
                                {
                                    get { return _dataSection.GetProperty(EedidProperty.Edid.BasicDisplay.Features.Other.IsContinuousFrequency) as DeviceProperty<Boolean>; }
                                }
                                #endregion
                        ...
                        public sealed class PowerManagementDisplayProperties
                        {
                            ...
                            #region Propiedades.
                                ...
                                /// 	<para>— Información de la propiedad</para>
                                /// 	<para>Description: Profundidad de color de este escritorio.</para>
                                /// 	<para>Key: <see cref="EedidProperty.Edid.BasicDisplay.Features.DisplayPowerManagement.StandbyModeSupported"/></para>
                                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                                /// 	<para>Value: <see cref="T:System.Boolean"/></para>
                                /// </summary>
                                /// <value>
                                ...
                                {
                                    get { return _dataSection.GetProperty(EedidProperty.Edid.BasicDisplay.Features.DisplayPowerManagement.StandbyModeSupported) as DeviceProperty<Boolean>; }
                                }
                                #endregion
                                ...
                                /// 	<para>— Información de la propiedad</para>
                                /// 	<para>Description: Profundidad de color de este escritorio.</para>
                                /// 	<para>Key: <see cref="EedidProperty.Edid.BasicDisplay.Features.DisplayPowerManagement.SuspendModeSupported"/></para>
                                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                                /// 	<para>Value: <see cref="T:System.Boolean"/></para>
                                /// </summary>
                                /// <value>
                                ...
                                {
                                    get { return _dataSection.GetProperty(EedidProperty.Edid.BasicDisplay.Features.DisplayPowerManagement.SuspendModeSupported) as DeviceProperty<Boolean>; }
                                }
                                #endregion
                                ...
                                /// 	<para>— Información de la propiedad</para>
                                /// 	<para>Description: Profundidad de color de este escritorio.</para>
                                /// 	<para>Key: <see cref="EedidProperty.Edid.BasicDisplay.Features.DisplayPowerManagement.ActiveOffSupported"/></para>
                                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                                /// 	<para>Value: <see cref="T:System.Boolean"/></para>
                                /// </summary>
                                /// <value>
                                ...
                                {
                                    get { return _dataSection.GetProperty(EedidProperty.Edid.BasicDisplay.Features.DisplayPowerManagement.ActiveOffSupported) as DeviceProperty<Boolean>; }
                                }
                                #endregion
            ...
            #region Propiedades
                ...
                /// 	<para>— Información de la propiedad</para>
                /// 	<para>Description: Profundidad de color de este escritorio.</para>
                /// 	<para>Key: <see cref="EedidProperty.Edid.BasicDisplay.VideoInputDefinition"/></para>
                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                /// 	<para>Value: <see cref="T:System.String"/></para>
                /// 	<para>Si está característica no se encuentra disponible se devuelve <b>null</b></para>
                /// </summary>
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.BasicDisplay.VideoInputDefinition) as DeviceProperty<String>; }
                }
                #endregion
                ...
                /// 	<para>— Información de la propiedad</para>
                /// 	<para>Description: Profundidad de color de este escritorio.</para>
                /// 	<para>Key: <see cref="EedidProperty.Edid.BasicDisplay.HorizontalScreenSize"/></para>
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.BasicDisplay.HorizontalScreenSize) as DeviceProperty<Byte>; }
                }
                #endregion
                ...
                /// 	<para>— Información de la propiedad</para>
                /// 	<para>Description: Profundidad de color de este escritorio.</para>
                /// 	<para>Key: <see cref="EedidProperty.Edid.BasicDisplay.VerticalScreenSize"/></para>
                /// 	<para>Unit: <see cref="PropertyUnit.cm"/></para>
                /// 	<para>Value: <see cref="T:System.Byte"/></para>
                /// 	<para>Si está característica no se encuentra disponible se devuelve <b>null</b></para>
                /// </summary>
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.BasicDisplay.VerticalScreenSize) as DeviceProperty<Byte>; }
                }
                #endregion
                ...
                /// 	<para>— Información de la propiedad</para>
                /// 	<para>Description: Profundidad de color de este escritorio.</para>
                /// 	<para>Key: <see cref="EedidProperty.Edid.BasicDisplay.Gamma"/></para>
                /// 	<para>Unit: <see cref="PropertyUnit.cm"/></para>
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.BasicDisplay.Gamma) as DeviceProperty<Double?>; }
                }
                #endregion
        ...
        public sealed class ColorCharacteristicsProperties
        {
            ...
            #region Propiedades
                ...
                /// 	<para>— Información de la propiedad</para>
                /// 	<para>Description: Número de versión de la especificación implementada en este monitor.</para>
                /// 	<para>Key: <see cref="EedidProperty.Edid.ColorCharacteristics.Red"/></para>
                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.ColorCharacteristics.Red) as DeviceProperty<PointF>; }
                }
                #endregion
                ...
                /// 	<para>— Información de la propiedad</para>
                /// 	<para>Description: Número de versión de la especificación implementada en este monitor.</para>
                /// 	<para>Key: <see cref="EedidProperty.Edid.ColorCharacteristics.Green"/></para>
                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                /// 	<para>Value: <see cref="T:System.Drawing.PointF"/></para>
                /// </summary>
                /// <value>
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.ColorCharacteristics.Green) as DeviceProperty<PointF>; }
                }
                #endregion
                ...
                /// 	<para>— Información de la propiedad</para>
                /// 	<para>Description: Número de versión de la especificación implementada en este monitor.</para>
                /// 	<para>Key: <see cref="EedidProperty.Edid.ColorCharacteristics.Blue"/></para>
                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                /// 	<para>Value: <see cref="T:System.Drawing.PointF"/></para>
                /// </summary>
                /// <value>
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.ColorCharacteristics.Blue) as DeviceProperty<PointF>; }
                }
                #endregion
                ...
                /// 	<para>— Información de la propiedad</para>
                /// 	<para>Description: Número de versión de la especificación implementada en este monitor.</para>
                /// 	<para>Key: <see cref="EedidProperty.Edid.ColorCharacteristics.White"/></para>
                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                /// 	<para>Value: <see cref="T:System.Drawing.PointF"/></para>
                /// </summary>
                /// <value>
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.ColorCharacteristics.White) as DeviceProperty<PointF>; }
                }
                #endregion
        ...
        public sealed class EstablishedTimingsProperties
        {
            ...
            #region Propiedades
                ...
                /// 	<para>Key: <see cref="EedidProperty.Edid.EstablishedTimings.Resolutions"/></para>
                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.EstablishedTimings.Resolutions) as DeviceProperty<ReadOnlyCollection<MonitorResolutionInfo>>; }
                }
                #endregion
        ...
        public sealed class StandardTimingsProperties
        {
            ...
            /// 	<para>— Información de la propiedad</para>
            /// 	<para>Description: Profundidad de color de este escritorio.</para>
            /// 	<para>Key: <see cref="EedidProperty.Edid.StandardTimings.Timing1"/></para>
            /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
            ...
            /// Objeto fuertemente tipado que representa el valor de la propiedad.
            /// </value>
            public DeviceProperty<StandardTimingIdentifierDescriptorItem> Timing1 => _dataSection.GetProperty(EedidProperty.Edid.StandardTimings.Timing1) as DeviceProperty<StandardTimingIdentifierDescriptorItem>;
            #endregion
            ...
            /// 	<para>— Información de la propiedad</para>
            /// 	<para>Description: Profundidad de color de este escritorio.</para>
            /// 	<para>Key: <see cref="EedidProperty.Edid.StandardTimings.Timing2"/></para>
            /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
            /// 	<para>Value: <see cref="StandardTimingIdentifierDescriptorItem"/></para>
            /// </summary>
            /// <value>
            /// Objeto fuertemente tipado que representa el valor de la propiedad.
            /// </value>
            public DeviceProperty<StandardTimingIdentifierDescriptorItem> Timing2 => _dataSection.GetProperty(EedidProperty.Edid.StandardTimings.Timing2) as DeviceProperty<StandardTimingIdentifierDescriptorItem>;
            #endregion
            ...
            /// 	<para>— Información de la propiedad</para>
            /// 	<para>Description: Profundidad de color de este escritorio.</para>
            /// 	<para>Key: <see cref="EedidProperty.Edid.StandardTimings.Timing3"/></para>
            /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
            /// 	<para>Value: <see cref="StandardTimingIdentifierDescriptorItem"/></para>
            /// </summary>
            /// <value>
            /// Objeto fuertemente tipado que representa el valor de la propiedad.
            /// </value>
            public DeviceProperty<StandardTimingIdentifierDescriptorItem> Timing3 => _dataSection.GetProperty(EedidProperty.Edid.StandardTimings.Timing3) as DeviceProperty<StandardTimingIdentifierDescriptorItem>;
            #endregion
            ...
            /// 	<para>— Información de la propiedad</para>
            /// 	<para>Description: Profundidad de color de este escritorio.</para>
            /// 	<para>Key: <see cref="EedidProperty.Edid.StandardTimings.Timing4"/></para>
            /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
            /// 	<para>Value: <see cref="StandardTimingIdentifierDescriptorItem"/></para>
            /// </summary>
            /// <value>
            /// Objeto fuertemente tipado que representa el valor de la propiedad.
            /// </value>
            public DeviceProperty<StandardTimingIdentifierDescriptorItem> Timing4 => _dataSection.GetProperty(EedidProperty.Edid.StandardTimings.Timing4) as DeviceProperty<StandardTimingIdentifierDescriptorItem>;
            #endregion
            ...
            /// 	<para>— Información de la propiedad</para>
            /// 	<para>Description: Profundidad de color de este escritorio.</para>
            /// 	<para>Key: <see cref="EedidProperty.Edid.StandardTimings.Timing5"/></para>
            /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
            /// 	<para>Value: <see cref="StandardTimingIdentifierDescriptorItem"/></para>
            /// </summary>
            /// <value>
            /// Objeto fuertemente tipado que representa el valor de la propiedad.
            /// </value>
            public DeviceProperty<StandardTimingIdentifierDescriptorItem> Timing5 => _dataSection.GetProperty(EedidProperty.Edid.StandardTimings.Timing5) as DeviceProperty<StandardTimingIdentifierDescriptorItem>;
            #endregion
            ...
            /// 	<para>— Información de la propiedad</para>
            /// 	<para>Description: Profundidad de color de este escritorio.</para>
            /// 	<para>Key: <see cref="EedidProperty.Edid.StandardTimings.Timing6"/></para>
            /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
            /// 	<para>Value: <see cref="StandardTimingIdentifierDescriptorItem"/></para>
            /// </summary>
            /// <value>
            /// Objeto fuertemente tipado que representa el valor de la propiedad.
            /// </value>
            public DeviceProperty<StandardTimingIdentifierDescriptorItem> Timing6 => _dataSection.GetProperty(EedidProperty.Edid.StandardTimings.Timing6) as DeviceProperty<StandardTimingIdentifierDescriptorItem>;
            #endregion
            ...
            /// 	<para>— Información de la propiedad</para>
            /// 	<para>Description: Profundidad de color de este escritorio.</para>
            /// 	<para>Key: <see cref="EedidProperty.Edid.StandardTimings.Timing7"/></para>
            /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
            /// 	<para>Value: <see cref="StandardTimingIdentifierDescriptorItem"/></para>
            /// </summary>
            /// <value>
            /// Objeto fuertemente tipado que representa el valor de la propiedad.
            /// </value>
            public DeviceProperty<StandardTimingIdentifierDescriptorItem> Timing7 => _dataSection.GetProperty(EedidProperty.Edid.StandardTimings.Timing7) as DeviceProperty<StandardTimingIdentifierDescriptorItem>;
            #endregion
            ...
            /// 	<para>— Información de la propiedad</para>
            /// 	<para>Description: Profundidad de color de este escritorio.</para>
            /// 	<para>Key: <see cref="EedidProperty.Edid.StandardTimings.Timing8"/></para>
            /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
            /// 	<para>Value: <see cref="StandardTimingIdentifierDescriptorItem"/></para>
            /// </summary>
            /// <value>
            /// Objeto fuertemente tipado que representa el valor de la propiedad.
            /// </value>
            public DeviceProperty<StandardTimingIdentifierDescriptorItem> Timing8 => _dataSection.GetProperty(EedidProperty.Edid.StandardTimings.Timing8) as DeviceProperty<StandardTimingIdentifierDescriptorItem>;
            #endregion
        ...
        public sealed class DataBlocksProperties
        {
            ...
            #region Miembros privados
                ...
                /// 	<para>Key: <see cref="EedidProperty.Edid.DataBlock.Descriptor1"/></para>
                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.DataBlock.Descriptor1) as DeviceProperty<KeyValuePair<PropertyKey, ReadOnlyCollection<Byte>>>; }
                }
                #endregion
                ...
                /// 	<para>— Información de la propiedad</para>
                /// 	<para>Description: Objeto que representa al contenido de la característica 'Preferred Timming Mode' de la sección 'Data blocks'.</para>
                /// 	<para>Key: <see cref="EedidProperty.Edid.DataBlock.Descriptor2"/></para>
                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                /// 	<para>Value: <see cref="KeyValuePair{TKey, TValue}"/></para>
                ///     <para><strong>TKey:</strong> <see cref="PropertyKey"/>, <strong>TValue:</strong> <see cref="ReadOnlyCollection{Byte}"/> </para>
                /// </summary>
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.DataBlock.Descriptor2) as DeviceProperty<KeyValuePair<PropertyKey, ReadOnlyCollection<Byte>>>; }
                }
                #endregion
                ...
                /// 	<para>— Información de la propiedad</para>
                /// 	<para>Description: Objeto que representa al contenido de la característica 'Preferred Timming Mode' de la sección 'Data blocks'.</para>
                /// 	<para>Key: <see cref="EedidProperty.Edid.DataBlock.Descriptor3"/></para>
                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                /// 	<para>Value: <see cref="KeyValuePair{TKey, TValue}"/></para>
                ///     <para><strong>TKey:</strong> <see cref="PropertyKey"/>, <strong>TValue:</strong> <see cref="ReadOnlyCollection{Byte}"/> </para>
                /// </summary>
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.DataBlock.Descriptor3) as DeviceProperty<KeyValuePair<PropertyKey, ReadOnlyCollection<Byte>>>; }
                }
                #endregion
                ...
                /// 	<para>— Información de la propiedad</para>
                /// 	<para>Description: Objeto que representa al contenido de la característica 'Preferred Timming Mode' de la sección 'Data blocks'.</para>
                /// 	<para>Key: <see cref="EedidProperty.Edid.DataBlock.Descriptor4"/></para>
                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                /// 	<para>Value: <see cref="KeyValuePair{TKey, TValue}"/></para>
                ///     <para><strong>TKey:</strong> <see cref="PropertyKey"/>, <strong>TValue:</strong> <see cref="ReadOnlyCollection{Byte}"/> </para>
                /// </summary>
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.DataBlock.Descriptor4) as DeviceProperty<KeyValuePair<PropertyKey, ReadOnlyCollection<Byte>>>; }
                }
                #endregion
        ...
        public sealed class ExtensionBlocksProperties
        {
            ...
            #region Propiedades
                ...
                /// 	<para>Key: <see cref="EedidProperty.Edid.ExtensionBlocks.Count"/></para>
                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                /// 	<para>Value: <see cref="T:System.Byte"/></para>
                /// </summary>
                /// <value>
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.ExtensionBlocks.Count) as DeviceProperty<Byte>; }
                }
                #endregion
                ...
                /// 	<para>— Información de la propiedad</para>
                /// 	<para>Description: Indica si existen bloques de extensión implementados.</para>
                /// 	<para>Key: <see cref="EedidProperty.Edid.ExtensionBlocks.HasBlocks"/></para>
                /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
                /// 	<para>Value: <see cref="T:System.Boolean"/></para>
                /// </summary>
                /// <value>
                ...
                {
                    get { return _dataSection.GetProperty(EedidProperty.Edid.ExtensionBlocks.HasBlocks) as DeviceProperty<Boolean>; }
                }
                #endregion
        ...
        public sealed class CheckSumProperties
        {
            ...
            #region [public] (DeviceProperty<Boolean>) Ok: Obtiene un objeto fuertemente tipado que representa el valor de esta propiedad.
            /// <summary>
            /// 	<para>Obtiene un objeto fuertemente tipado que representa el valor de esta propiedad.</para>
            /// 	<para>— Información de la propiedad</para>
            /// 	<para>Description: Número de revisión de la especificación implementada en este monitor.</para>
            /// 	<para>Key: <see cref="EedidProperty.Edid.CheckSum.Ok"/></para>
            /// 	<para>Unit: <see cref="PropertyUnit.None"/></para>
            /// 	<para>Value: <see cref="T:System.Boolean"/></para>
            /// </summary>
            /// <value>
            /// Objeto fuertemente tipado que representa el valor de la propiedad.
            /// </value>
            public DeviceProperty<Boolean> Ok
            {
                get { return _dataSection.GetProperty(EedidProperty.Edid.CheckSum.Ok) as DeviceProperty<Boolean>; }
            }
            #endregion
