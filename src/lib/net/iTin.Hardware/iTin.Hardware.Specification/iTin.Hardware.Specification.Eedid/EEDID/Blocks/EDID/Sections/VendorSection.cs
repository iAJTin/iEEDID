...
namespace iTin.Hardware.Specification.Eedid.Blocks.EDID.Sections
{
    ...
    /// Represents the <see cref="EdidSection.Vendor"/> section of this block <see cref="KnownDataBlock.EDID"/>.
    /// </summary> 
    internal sealed class VendorSection : BaseDataSection
    {
        #region constructor/s

        #region [public] VendorSection(ReadOnlyCollection<byte>): Initialize a new instance of the class with the data in this section untreated
        /// <summary>
        /// Initialize a new instance of the <see cref="VendorSection"/> class with the data in this section untreated.
        /// </summary>
        /// <param name="sectionData">Unprocessed data in this section</param>
        public VendorSection(ReadOnlyCollection<byte> sectionData) : base(sectionData)
        {
        }
        #endregion
