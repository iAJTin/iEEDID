...
namespace iTin.Core.Hardware.Specification.Eedid
{
    ...
    internal class VtbBlock : BaseDataBlock
    {
        ...
        /// <inheritdoc />
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="T:iTin.Core.Hardware.Specification.Eedid.VtbBlock" /> con los datos de este bloque sin tratar.
        /// </summary>
        /// <param name="dataBlock">Datos de este bloque sin tratar.</param>
        /// <remarks>
        /// Crear bloque <see cref="F:iTin.Core.Hardware.Specification.Eedid.KnownDataBlock.VTB" /> que pertenece a la especificación <see cref="T:iTin.Core.Hardware.Specification.EEDID" />.
        /// </remarks>
