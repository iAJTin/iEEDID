...
namespace iTin.Hardware.Specification.Eedid
{
    ...
    /// Represents the <see cref="KnownDiSection.DisplayDevice"/> section of this block <see cref="KnownDataBlock.DI"/>.
    /// </summary> 
    internal sealed class DisplayDeviceDiSection : BaseDataSection
    {
        #region constructor/s

        #region [public] DisplayDeviceDiSection(ReadOnlyCollection<byte>): Initializes a new instance of the class with the data from this raw section
        /// <summary>
        /// Initializes a new instance of the <see cref="DisplayDeviceDiSection"/> class with the data from this raw section.
        /// </summary>
        /// <param name="sectionData">Data from this section untreated.</param>
        public DisplayDeviceDiSection(ReadOnlyCollection<byte> sectionData) : base(sectionData)
        {
        }
        #endregion
