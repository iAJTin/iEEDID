...
namespace iTin.Core.Hardware.Specification.Eedid
{
    ...
    /// <inheritdoc />
    /// <summary>
    /// Specialization of the <see cref="T:iTin.Core.Hardware.Specification.Eedid.BaseDataSection" /> class that represents the <see cref="F:iTin.Core.Hardware.Specification.Eedid.KnownEdidSection.DataBlocks" /> section of type this block <see cref="EdidDataBlockDescriptor.AlphaNumericDataString" />.
    /// </summary> 
    internal sealed class AlphaNumericDataStringDescriptor : BaseDataSection
    {
        ...
        /// <inheritdoc />
        /// <summary>
        /// Initialize a new instance of the <see cref="T:iTin.Core.Hardware.Specification.Eedid.AlphaNumericDataStringDescriptor" /> class with the data of this block untreated.
        /// </summary>
