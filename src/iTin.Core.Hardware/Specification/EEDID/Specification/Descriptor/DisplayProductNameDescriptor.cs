...
namespace iTin.Core.Hardware.Specification.Eedid
{
    ...
    /// <summary>
    /// Especialización de la clase <see cref="BaseDataSection"/> que representa a un <see cref="KnownEdidSection.DataBlocks"/> de tipo <see cref="KnownEdidDataBlockDescriptor.DisplayProductName"/>.
    /// </summary>
    sealed class DisplayProductNameDescriptor : BaseDataSection
    {
        #region Constructor/es

            #region [public] DisplayProductNameDescriptor(ReadOnlyCollection<byte>): Inicializa una nueva instancia de la clase con los datos de este bloque sin tratar.
            /// <summary>
            /// Inicializa una nueva instancia de la clase <see cref="DisplayProductNameDescriptor"/> con los datos de este bloque sin tratar.
            /// </summary>
            /// <param name="blockData">Datos de este bloque sin tratar.</param>
            public DisplayProductNameDescriptor(ReadOnlyCollection<byte> blockData) : base(blockData)
            {
            }
            #endregion
        ...
        #region Overrides
            ...
            protected override void Parse(Hashtable items)
            {
                ...
                items.Add(KnownEedidPropertiesDefinition.Edid.DataBlock.Definition.DisplayProductName.Text, GetAsciiText(RawDataArray));
                #endregion
            }
            #endregion
