...
namespace iTin.Hardware.Specification.Eedid
{
    ...
    /// Represents the <see cref="KnownDiSection.DigitalInterface"/> section of this block <see cref="KnownDataBlock.DI"/>.
    /// </summary> 
    internal sealed class DigitalInterfaceDiSection : BaseDataSection
    {
        #region constructor/s

        #region [public] DigitalInterfaceDiSection(ReadOnlyCollection<byte>): Initializes a new instance of the class with the data from this raw section
        /// <summary>
        /// Initializes a new instance of the <see cref="DigitalInterfaceDiSection"/> class with the data from this raw section.
        /// </summary>
        /// <param name="sectionData">Data from this section untreated.</param>
        public DigitalInterfaceDiSection(ReadOnlyCollection<byte> sectionData) : base(sectionData)
        {
        }
        #endregion
