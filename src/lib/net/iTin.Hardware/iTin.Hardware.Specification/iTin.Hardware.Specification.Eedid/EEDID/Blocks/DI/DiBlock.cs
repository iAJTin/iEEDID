...
namespace iTin.Hardware.Specification.Eedid
{
    ...
    internal class DiBlock : BaseDataBlock
    {
        ...
        /// <inheritdoc />
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="T:iTin.Hardware.Specification.Eedid.DiBlock" /> con los datos de esta sección sin tratar.
        /// </summary>
        /// <param name="dataBlock">Datos sin tratar de este bloque.</param>
        /// <remarks>
        /// Crear bloque <see cref="F:iTin.Hardware.Specification.Eedid.KnownDataBlock.DI" /> que pertenece a la especificación <see cref="T:iTin.Hardware.Specification.EEDID" />.
        /// </remarks>
