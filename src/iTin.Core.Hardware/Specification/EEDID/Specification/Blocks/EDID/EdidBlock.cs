...
namespace iTin.Core.Hardware.Specification.Eedid
{
    ...
    /// </summary> 
    sealed class EdidBlock : BaseDataBlock
    {
        #region constructor/s

        #region [public] EdidBlock(ReadOnlyCollection<byte>): Inicializa una nueva instancia de la clase con los datos de esta sección sin tratar.
        /// <inheritdoc />
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="T:iTin.Core.Hardware.Specification.Eedid.EdidBlock" /> con los datos de esta sección sin tratar.
        /// </summary>
        /// <param name="dataBlock">Datos sin tratar de este bloque.</param>
        /// <remarks>
        /// Crear bloque <see cref="F:iTin.Core.Hardware.Specification.Eedid.KnownDataBlock.EDID" /> (Bloque 0) que pertenece a la especificación <see cref="T:iTin.Core.Hardware.Specification.EEDID" />.
        /// </remarks>
