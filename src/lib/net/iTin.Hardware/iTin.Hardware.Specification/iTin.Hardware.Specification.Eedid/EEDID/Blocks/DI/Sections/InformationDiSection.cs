...
namespace iTin.Hardware.Specification.Eedid
{
    ...
    /// Represents the <see cref="KnownDiSection.Information"/> section of this block <see cref="KnownDataBlock.DI"/>.
    /// </summary> 
    internal sealed class InformationDiSection : BaseDataSection
    {
        #region constructor/s

        #region [public] InformationDiSection(ReadOnlyCollection<byte>): Initializes a new instance of the class with the data from this raw section
        /// <summary>
        /// Initializes a new instance of the <see cref="InformationDiSection"/> class with the data from this raw section.
        /// </summary>
        /// <param name="sectionData">Data from this section untreated.</param>
        public InformationDiSection(ReadOnlyCollection<byte> sectionData) : base(sectionData)
        {
        }
        #endregion
