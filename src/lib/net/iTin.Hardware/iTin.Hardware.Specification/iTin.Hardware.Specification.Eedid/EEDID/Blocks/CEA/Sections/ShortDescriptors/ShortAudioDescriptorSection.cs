...
namespace iTin.Hardware.Specification.Eedid.Blocks.CEA.Sections.Descriptors
{
    ...
    /// </summary> 
    sealed class ShortAudioDescriptorSection : BaseDataSection
    {
        #region constructor/s

        #region [public] ShortAudioDescriptorSection(ReadOnlyCollection<byte>): Initialize a new instance of the class
        /// <summary>
        /// Initialize a new instance of the <see cref="ShortAudioDescriptorSection"/> class with the data in this section untreated.
        /// </summary>
        /// <param name="sectionData">Raw data of this section.</param>
        public ShortAudioDescriptorSection(ReadOnlyCollection<byte> sectionData) : base(sectionData)
        {
        }
        #endregion
