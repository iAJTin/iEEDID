...
namespace iTin.Core.Hardware.Specification.Eedid
{
    ...
    /// <summary>
    /// Represents the <see cref="F:iTin.Core.Hardware.Specification.Eedid.KnownEdidSection.DataBlocks" /> of type <see cref="F:iTin.Core.Hardware.Specification.Eedid.KnownEdidDataBlockDescriptor.StandardTimingIdentifier" />.
    /// </summary>
